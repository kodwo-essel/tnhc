...
const SOCIAL_HANDLES = [
  {
    platform: "Instagram",
    handle: "@thenewhousechurch",
    href: "https://www.instagram.com/thenewhousechurch?igsh=ejcxNzkxa2s3OG8z",
    color: "#E1306C",
    icon: (
  ...
  },
  {
    platform: "YouTube",
    handle: "@thenewhousechurch",
    href: "https://youtube.com/@thenewhousechurch?si=8tsyVbZOgjN3sP7i",
    color: "#FF0000",
    icon: (
      <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
  ...
  // },
  {
    platform: "TikTok",
    handle: "@thenewhousechurch",
    href: "https://www.tiktok.com/@thenewhousechurch?_r=1&_t=ZS-94KmO84G3Pj",
    color: "#00f2ea",
    icon: (
      <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section ref={sectionRef} className="w-full bg-black px-6 py-24 sm:py-40">
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div
          className={`grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12 sm:gap-16 transition-all duration-1000 delay-500 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            }`}
        >
