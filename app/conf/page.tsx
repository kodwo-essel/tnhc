            ...
            <section ref={speakersRef} className="w-full bg-black py-32 px-6">
                <div className={`max-w-7xl mx-auto transition-all duration-1000 ${speakersVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20">
                        <SpeakerCard name="Kodwo Essel" role="Host & Senior Pastor" image="/logo/photo_2026-02-26_09-44-11.jpg" delay="delay-0" />
                        <SpeakerCard name="Akua Essel" role="Host & Lead Pastor" image="/logo/photo_2026-02-26_09-44-11 (Copy).jpg" delay="delay-200" />
