                    ...
                    <div className="flex flex-col lg:flex-row gap-20 items-center lg:items-start">
                        ...
                        >
                            ...
                            <div className="space-y-6">
                                ...
                                >
                                    Kodwo and Akua are passionate about reaching the city of Accra, and for our
                                ...
                                <p
                                    ...
                                    style={{ fontFamily: "var(--font-dm-sans)" }}
                                >
                                    Kodwo is a passionate teacher of God&apos;s Word who believes deeply in the
                            ...
                            <div className="flex flex-wrap gap-6 pt-6">
                                ...
                                >
                                    ...
                                    <span className="text-xs font-black tracking-widest uppercase">@KODWOESSEL</span>
                                </a>
                                <a
                                    href="https://www.instagram.com/tnhcaccra/"
                                    target="_blank"
                                ...
                                >
                                    ...
                                    <span className="text-xs font-black tracking-widest uppercase">@AKUAESSEL</span>
                                </a>
                            </div>
                        </div>
                    </div>
